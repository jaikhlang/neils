            ...
            <div class="mb-3">
              ...
              <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <form class="" action="{{ route('participant.update', $user) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4 row">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ $user->phone }}" maxlength="10" required autofocus>
                            @error('phone')
                        ...
                        <div class="mb-4 row">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" name="passportnumber" class="form-control @error('passportnumber') is-invalid @enderror" value="{{ old('passportnumber') }}" required>
                        ...
                        <div class="mb-4">
                          <button type="button" v-if="!acceptTermsNcondition" class="btn btn-outline-secondary btn-lg cursor-pointer" disabled>Saves & Continue</button>
                          <input type="submit" name="" v-if="acceptTermsNcondition" class="btn btn-outline-success btn-lg" value="Saves & Continue">
                        </div>
                      </form>
                  </div>
              </div>
