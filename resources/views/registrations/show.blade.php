            ...
            <div class="mb-3">
              ...
              <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <form class="" action="{{ route('participant.update', $user) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm('After this operation you can not edit the form. Do you really want to submit the form?');">
                        ...
                        @if($user->category->code_no == 2)
                        <div class="mb-4 pb-2 px-2 rounded">
                          <label for="document_url">Evidence such as a letter from the Head of the Department.</label>
                          <a href="{{ asset($user->document_url) }}" class="btn btn-primary d-inline-block">Document</a>
                        </div>
                        @endif
